...
const getProductFeatures = (category: string): string[] => {
  const features: Record<string, string[]> = {
    Electronics:  ['Advanced technology for superior performance', 'Energy efficient design', 'Smart connectivity features', 'Premium build quality'],
    Fashion:      ['Premium fabric quality', 'Comfortable fit', 'Trendy design', 'Easy maintenance'],
    Home:         ['Durable construction', 'Modern design aesthetic', 'Premium materials', 'Easy to clean'],
    Appliances:   ['Energy-efficient operation', 'Advanced features', 'Quiet performance', 'Smart controls'],
    Travel:       ['Durable construction', 'Lightweight design', 'Weather-resistant', 'Ample storage'],
    Beauty:       ['Premium ingredients', 'Dermatologist tested', 'Long-lasting results', 'Gentle formula'],
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-4 rounded-lg sticky top-20">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              <button
                className="flex items-center justify-center gap-2 bg-[#ff9f00] text-white py-4 px-6 rounded-lg font-medium hover:bg-[#ff9500] transition-colors"
              ...
              <button
                className="flex items-center justify-center gap-2 bg-[#fb641b] text-white py-4 px-6 rounded-lg font-medium hover:bg-[#fb5c1b] transition-colors"
          ...
          <div className="space-y-6">
              ...
              {activeTab === 'reviews' && (
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-sm text-gray-500">Based on {product.reviews.toLocaleString()} reviews</span>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <p className="text-gray-600 text-center">Review details coming soon…</p>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="border-t border-gray-200 pt-6">
              <h3 className="font-medium text-lg mb-4">Features &amp; Details</h3>
